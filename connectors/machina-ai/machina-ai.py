...
DEFAULT_CONFIG: Dict[str, Any] = {
    ...
    "providers": {
        "vertex_ai": {
            ...
            "location": "global",
            "allowed_models": {
                "chat": ["gemini-3.8-flash", "gemini-3.7-flash", "gemini-3.5-flash-lite", "gemini-2.5-flash", "gemini-2.5-pro", "gemini-2.5-flash-lite"],
                "embedding": ["text-embedding-004"],
                "search_answer": ["gemini-3.8-flash", "gemini-3.7-flash", "gemini-3.5-flash-lite", "gemini-2.5-flash", "gemini-2.5-pro"],
