...
def context(params):
    ...
    prompt = (
        'Write ONE sharp, entertaining Machina sports post, not a report, generic matchup label or market table. '
        'Lead the headline with the most interesting evidence-backed tension, surprise or contrast, not just team names and a competition. '
        'Keep the headline to roughly five to ten words: an intriguing sporting take, not a percentage, record dump or injury bulletin. '
        'Use a conversational, opinionated but fair voice, short sentences and vivid everyday language. Make a reader want to argue the sporting interpretation. '
        ...
        'The headline or body MUST contain a quoted market fact and cite its market source. Copy its numeric quote exactly as supplied, including decimal places; do not round or calculate new numbers. '
        'In the body connect that fact to actual results/standings/stats and explain why the contrast matters, rather than listing prices and records. Relevant reported news may add context, not invented causality. '
        'Use one market quote in the body, not a price comparison table. A quoted YES bid-ask is a contract price, never market share or our win probability. '
        'These are outright championship futures across the whole league, not next-game odds. A strong record alone does not show that a title price is too low, too high or mispriced. '
        'Do not invent a disagreement between results and price, fair-value baseline, or collective emotion such as fear, disbelief or panic. Explain the supported sporting contrast without diagnosing what traders think. '
        'A useful angle is what a strong regular-season resume does and does not settle about winning a title; a joke can puncture swagger without pretending to know fair odds. '
        'Prioritize the sporting contrast in records or form. Keep availability reports neutral in the analysis, not the central comic angle. A win total already achieved is not a total the team is chasing. '
        'Add one brief, original wry metaphor or playful punchline when it fits: tease team inconsistency, sporting hype or the gap between reputation and results. '
        'Make that playful payoff visible in the body, not buried in analysis. Favor a quick ironic analogy over a generic disclaimer about guarantees. '
        'Humor is commentary, not evidence. Never invent an incident or quote to land a joke. No jokes about injuries, illness, tragedy, identity or personal appearance; no slurs, cruelty or harassment. '
        'Do not force a joke when the evidence is serious. Avoid repeated stock punchlines, corporate filler, clickbait promises, hashtags and emoji piles. '
        'Each analysis point must connect cited evidence to a clear sporting implication, then a relevant limitation or what to watch next. '
        'Explain what the evidence suggests and what it cannot establish. Do not merely restate the body or numbers. Frame interpretations as interpretations, not hidden facts or certain predictions. '
