...
MAPPINGS = {
    **{("machina-ai", command): command for command in (
    ...
    ("cerebras", "invoke_prompt"): "invoke_prompt(profile=fast)",
    ("cerebras", "invoke_chat"): "invoke_chat",
    ("cerebras", "list_models"): "list_models",
    ("cerebras", "health"): "health",
    ("cerebras", "completion_receipt"): "invoke_chat(execute)",
